...
namespace BIMFM.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        private readonly BIMFMDbContext _context;
        private readonly int _tenantId;

        public TenantRoleAndUserBuilder(BIMFMDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new BIMFMAuthorizationProvider())
