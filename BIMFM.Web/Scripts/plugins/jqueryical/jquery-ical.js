...
(function ($) {
    ...
    $.fn.ical = function (options) {
        $.fn.ical.defaults = {
            daynames: ['一', '二', '三', '四', '五', '六', '日'], //default short names for the days of the week
        ...
        */
        function createNavigation(obj, insdate) {
            obj.append("<div style='font-size:19px'><span id = 'currentmonth'>" + options.monthnames[insdate.getMonth()] + "</span> <span id = 'currentyear'>" + insdate.getFullYear() + "</span></div>" +
                      "<div><span id ='icalprev'><i class='icon-chevron-left'></i></span><span id ='icalnext'><i class='icon-chevron-right'></i></span></div>");
        ...
        */
        ...
        function addDatesToTable(obj, insdate) {
            ...
            if (first >= 0 && first <= 7 && afterpadding <= 6 && $(".icaltable>tbody>tr").length < 6) {
                $(".icaltable", obj).append("<tr><td class = 'padding'></td><td class = 'padding'></td><td class = 'padding'></td><td class = 'padding'></td><td class = 'padding'></td><td class = 'padding'></td><td class = 'padding'></td></tr>");
            }
